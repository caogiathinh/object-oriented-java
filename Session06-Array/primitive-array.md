[[OOP]]
## I. Mảng là gì ?
- Mảng là kĩ thuật khai bao nhiều biến, nhiều biến nhiều value, nhiều phần tử nhiều value tương ứng.
- Mảng là kĩ thuật khai báo nhiều biến cùng kiểu, cùng lúc ở sát nhau trong RAM, và CÙNG TÊN
- Khi trùng tên, phải có cách để phân biệt biến này với biến kia, dùng tên phụ [index]
	- An[A]
	- An[B]
- Giá trả: khai báo nhanh hơn, nhưng tên biến phức tạp hơn.
- Chơi với MẢNG thì chơi với **LOOP** ( do-while, for, while)
	- Do index tăng dần đều từ 0. 
## II. Code
```
